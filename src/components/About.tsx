...
const About: React.FC = () => {
  ...
  return (
    <section className="py-16 bg-gradient-to-br from-white to-blue-50">
      ...
      >
        <motion.h2 
          className="text-2xl md:text-3xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600"
        ...
        <motion.p 
          ...
          variants={itemVariants}
        >
          מקווה שהמדריך עזר! אני [Your Name], מפתח תוכנה שמתמסר ליצירת פתרונות דיגיטליים ברורים ומועילים. אם אתם מחפשים מפתח עם יכולות בפיתוח Full Stack או Mobile, או זקוקים לדף נחיתה מקצועי לפרויקט שלכם, אשמח ליצור קשר.
        </motion.p>
